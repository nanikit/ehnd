...
__declspec(naked) int __stdcall _WideCharToMultiByte(UINT a, DWORD b, LPCWSTR c, int d, LPSTR e,
                                                     int f, LPCSTR g, LPBOOL h) {
  if (wc2mb_type == 1) {
    __asm
    {
...
__declspec(naked) int __stdcall _MultiByteToWideChar(UINT a, DWORD b, LPCSTR c, int d, LPWSTR e,
                                                     int f) {
  if (mb2wc_type == 1) {
    __asm
    {
